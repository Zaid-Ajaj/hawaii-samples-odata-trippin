...
type MicrosoftODataSampleServiceModelsTripPinLocation =
    ...
    static member Create (): MicrosoftODataSampleServiceModelsTripPinLocation = { Address = None; City = None }
...
type MicrosoftODataSampleServiceModelsTripPinPhoto =
    ...
    static member Create (): MicrosoftODataSampleServiceModelsTripPinPhoto = { Id = None; Name = None }
...
type MicrosoftODataSampleServiceModelsTripPinPerson =
    { UserName: Option<string>
      ...
      AddressInfo: Option<list<string>>
...
type MicrosoftODataSampleServiceModelsTripPinAirline =
    ...
    static member Create (): MicrosoftODataSampleServiceModelsTripPinAirline = { AirlineCode = None; Name = None }

type MicrosoftODataSampleServiceModelsTripPinAirport =
    { IcaoCode: Option<string>
      Name: Option<string>
      IataCode: Option<string>
      Location: Option<MicrosoftODataSampleServiceModelsTripPinAirportLocation> }
...
type MicrosoftODataSampleServiceModelsTripPinEvent =
    { PlanItemId: Option<int>
      ...
      OccursAt: Option<MicrosoftODataSampleServiceModelsTripPinEventLocation> }
...
type EdmGeographyPoint =
    ...
    static member Create (``type``: Type, coordinates: list<float>): EdmGeographyPoint =
        { ``type`` = ``type``
...
type EdmGeographyLineString =
    ...
    static member Create (``type``: EdmGeographyLineStringType, coordinates: list<list<float>>): EdmGeographyLineString =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeographyPolygon =
    ...
    static member Create (``type``: EdmGeographyPolygonType, coordinates: list<list<list<float>>>): EdmGeographyPolygon =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeographyMultiPoint =
    ...
    static member Create (``type``: EdmGeographyMultiPointType, coordinates: list<list<float>>): EdmGeographyMultiPoint =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeographyMultiLineString =
    ...
    static member Create (``type``: EdmGeographyMultiLineStringType, coordinates: list<list<list<float>>>): EdmGeographyMultiLineString =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeographyMultiPolygon =
    ...
    static member Create (``type``: EdmGeographyMultiPolygonType, coordinates: list<list<list<list<float>>>>): EdmGeographyMultiPolygon =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeometryPoint =
    ...
    static member Create (``type``: EdmGeometryPointType, coordinates: list<float>): EdmGeometryPoint =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeometryLineString =
    ...
    static member Create (``type``: EdmGeometryLineStringType, coordinates: list<list<float>>): EdmGeometryLineString =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeometryPolygon =
    ...
    static member Create (``type``: EdmGeometryPolygonType, coordinates: list<list<list<float>>>): EdmGeometryPolygon =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeometryMultiPoint =
    ...
    static member Create (``type``: EdmGeometryMultiPointType, coordinates: list<list<float>>): EdmGeometryMultiPoint =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeometryMultiLineString =
    ...
    static member Create (``type``: EdmGeometryMultiLineStringType, coordinates: list<list<list<float>>>): EdmGeometryMultiLineString =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type EdmGeometryMultiPolygon =
    ...
    static member Create (``type``: EdmGeometryMultiPolygonType, coordinates: list<list<list<list<float>>>>): EdmGeometryMultiPolygon =
        { ``type`` = ``type``
          coordinates = coordinates }
...
type odataerror =
    ...
    static member Create (error: odataerrormain): odataerror = { error = error }
...
type MeListRefFriends_OK = { value: Option<list<string>> }
[<RequireQualifiedAccess>]
...
type MeGetFriendsTrips =
    ///Success
    | OK of payload: list<MicrosoftODataSampleServiceModelsTripPinTrip>
    ///error
    | DefaultResponse of payload: odataerror
...
type MeTripsTripGetInvolvedPeople =
    ///Success
    | OK of payload: list<MicrosoftODataSampleServiceModelsTripPinPerson>
    ///error
    | DefaultResponse of payload: odataerror
...
type MeTripsListRefPhotos_OK = { value: Option<list<string>> }
[<RequireQualifiedAccess>]
